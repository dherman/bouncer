/**
 * Parser for Bouncer policy event log lines from stderr (M5).
 *
 * Parses [bouncer:gh] and [bouncer:git] structured log lines emitted
 * by the gh shim and pre-push hook into PolicyEvent objects.
 *
 * Expected formats:
...
const POLICY_LINE_RE = /^\[bouncer:(gh|git)\] (ALLOW|DENY) (.+)$/;
